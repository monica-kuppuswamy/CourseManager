...
public class LoginFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Button login = (Button) getActivity().findViewById(R.id.buttonLogin);
        TextView signUp = (TextView) getActivity().findViewById(R.id.signUp);
        login.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                if(mListener.isValidUser(username.getText().toString(), password.getText().toString())) {
                    mListener.goToCourseManagerFromLogin(username.getText().toString());
                } else {
    ...
    public interface OnFragmentInteractionListener {
        ...
        void goToSignUpPage();
        void goToCourseManagerFromLogin(String user);
    }
}
